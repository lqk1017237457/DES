...
public class Test {
	public static void main(String[] args) {
		String str = "0011000100110010001100110011010000110101001101100011011100111000";
		byte[] sKey = str.getBytes();
		for (int i = 0; i < sKey.length; i++) 
			sKey[i] -= '0';
		System.out.print("密钥：");
		printByteArr(sKey);
		str = "0011000000110001001100100011001100110100001101010011011000110111";
